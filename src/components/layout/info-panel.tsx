...
<<<<<<< HEAD
                <DialogContent><DialogHeader><DialogTitle>About The Quantum Cat</DialogTitle></DialogHeader><div className="space-y-2 text-sm text-muted-foreground"><p>Version 3.1</p><p>This app is a playful exploration of the famous Schrödinger's Cat thought experiment.</p><p>What state will your cat be in?</p></div></DialogContent>
=======
